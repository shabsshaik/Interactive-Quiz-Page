...
prev_btn.onclick = () => {
    if (que_count > 0) {
        ...
        showQuetions(que_count); // show the previous question
        ...
        startTimer(timeValue); // start the timer for the previous question
        startTimerLine(widthValue); // start the timer line for the previous question
